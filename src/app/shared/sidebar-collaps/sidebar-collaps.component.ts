...
@Component({
  selector: 'app-sidebar-collaps',
  templateUrl: './sidebar-collaps.component.html',
  styleUrls: ['./sidebar-collaps.component.scss'],
})
export class SidebarCollapsComponent  implements OnInit {

  loggedInUserRole:any;
    sidebarModule:any=[
      {
        moduleActiveIcon: '././assets/icon/dashboardRedIcon.svg',
        moduleInactiveIcon: '././assets/icon/dashboardRedIcon.svg',
        ModuleName: 'Dashboard',
        routerName: '/home/dashboard'
      },
      {
        moduleActiveIcon: '././assets/icon/UAUCObservationsRedIcon.svg',
    ...
    configModule = [
      {
        moduleActiveIcon: '././assets/icon/userManagementRedIcon.svg',
